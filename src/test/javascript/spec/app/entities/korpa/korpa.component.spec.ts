...
import { KorpaComponent } from 'app/entities/korpa/korpa.component';
import { KorpaService } from 'app/entities/korpa/korpa.service';
import { Korpa } from 'app/shared/model/korpa.model';

describe('Component Tests', () => {
  describe('Korpa Management Component', () => {
    let comp: KorpaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KorpaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.korpas && comp.korpas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
